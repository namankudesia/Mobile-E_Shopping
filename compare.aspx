<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="compare.aspx.cs" Inherits="Mobile_EShopping.compare" %>
        ...
        <div>
            <table class="auto-style1">
                    ...
                    <td>
                        <table class="auto-style1">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource4" DataTextField="Manf_id" DataValueField="Manf_id">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource2" GridLines="Vertical" Width="100%" DataKeyNames="Model_id" >
                    ...
                    <td>
                        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource5" GridLines="Vertical" Width="100%" DataKeyNames="Model_id" >
                            <AlternatingRowStyle BackColor="#DCDCDC" />
                            <Columns>
                                <asp:BoundField DataField="Model_id" HeaderText="Model Name" SortExpression="Model_id" />
                                <asp:BoundField DataField="model_price" HeaderText="Price" SortExpression="model_price" />
                                <asp:TemplateField HeaderText="Image" SortExpression="model_image">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("model_image") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Image ID="Image3" runat="server" Height="200px" ImageUrl='<%# Eval("model_image") %>' Width="200px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Flipkart Link">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("model_link_flipcart") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl='<%# Eval("model_link_flipcart") %>' Text='Flipkart'></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ConvertEmptyStringToNull="False" HeaderText="Amazon Link" SortExpression="model_linkamazon">
                                    <EditItemTemplate>
                                        <asp:DynamicControl ID="DynamicControl2" runat="server" DataField="model_linkamazon" Mode="Edit" />
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl='<%# Eval("model_linkamazon") %>'>Amazon</asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:CommandField ShowSelectButton="True" />
                            </Columns>
                ...
                <tr>
                    ...
                    <td>
                        <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Manf_id,Model_id,Group_id,Subgroup_id" DataSourceID="SqlDataSource6" GridLines="None" Width="100%" ForeColor="#333333">
                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                            <Columns>
                                <asp:BoundField DataField="Subgroup_id" HeaderText="Details" ReadOnly="True" SortExpression="Subgroup_id" >
                                <ItemStyle ForeColor="#CC0000" />
                ...
                <tr>
                    ...
                    <td>
                        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT distinct[Manf_id] FROM [Model]"></asp:SqlDataSource>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Model_id], [model_price], [model_image], [model_linkamazon], [model_link_flipcart] FROM [Model] WHERE ([Manf_id] = @Manf_id)">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="DropDownList2" Name="Manf_id" PropertyName="SelectedValue" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Model_des] WHERE (([Manf_id] = @Manf_id) AND ([Model_id] = @Model_id)) ORDER BY [code]">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="DropDownList2" Name="Manf_id" PropertyName="SelectedValue" Type="String" />
                                <asp:ControlParameter ControlID="GridView3" Name="Model_id" PropertyName="SelectedValue" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </td>
                    <td>&nbsp;</td>
